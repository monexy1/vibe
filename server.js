...
const server = http.createServer(async (req, res) => {
    ...
    if (req.method === "GET" && pathname === "/users") {
        ...
        const result = users
            ...
            .map(user => publicUser(user, current));
    ...
    if (req.method === "GET" && pathname === "/friends") {
        ...
        const result = users
            .filter(user =>
                current.friends.includes(user.login)
            )
            .map(user =>
                publicUser(user, login)
            );
    ...
    if (req.method === "POST" && pathname === "/friends") {
        try {
            ...
            if (action === "add") {
                ...
                if (!userB.friends.includes(from)) {
